...
sys.path.append('Helper/deep_sort/deep/reid')
from Utils.ObjectTrackers.DeepSort.Helper.deep_sort.deep.reid.torchreid import models
...
class Extractor(object):
    def __init__(self, model_type, use_cuda=True):
        ...
        logger = logging.getLogger("root.Helper")
